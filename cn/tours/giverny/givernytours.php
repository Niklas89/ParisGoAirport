...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 吉维尼小镇观光</title>

        <meta name="description" content="吉维尼小镇观光">
        <meta name="keywords" content="吉维尼小镇游,吉维尼,吉维尼游,吉维尼小镇观光">
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>吉维尼小镇观光</h2><!--END TITLE-->

                 <div class="tourscat">
                    <a href="giverny.php" title="吉维尼小镇游"><img src="giverny160.jpg" alt="吉维尼小镇游" /></a>
                    <p><a href="giverny.php" title="吉维尼小镇游">吉维尼小镇游</a></p>
                  </div>
