...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 凡尔赛宫一日游</title>

        <meta name="description" content="凡尔赛宫一日游">
        <meta name="keywords" content="凡尔赛宫一日游">
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>凡尔赛宫一日游</h2><!--END TITLE-->

        <div class="singletours">

              <img src="versailles300h.jpg" alt="凡尔赛宫一日游" /> 
               <p>全天参观凡尔赛皇宫，领略被称为“太阳之王”路易十四时期法国建筑风格和珍稀皇室珍宝的风采.</p>
              <p class="time">出发：每周三，六，日 早8:30  全程时长：大约8个小时</p>
              <p class="tourprice">成人: 185 欧元<br />孩子（4-11岁）: 142 欧元</p>
