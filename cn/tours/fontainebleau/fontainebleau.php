...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 枫丹白露宫和巴比桑小镇游</title>

        <meta name="description" content="枫丹白露宫和巴比桑小镇游">
        <meta name="keywords" content="枫丹白露宫和巴比桑小镇游">
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>枫丹白露宫和巴比桑小镇游</h2><!--END TITLE-->

        <div class="singletours">

              <img src="fontainebleau300h.jpg" alt="Fontainebleau & Barbizon Tour" /> 
              <p>出发时间：每周一，四，六下午1:30从您入住的酒店出发<br />全程时长：大约5个小时</p>
              <p class="tourprice">费用 94.05 欧元</p>
