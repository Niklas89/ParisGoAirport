...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 游览巴黎市区+枫丹白露宫和巴比桑小镇</title>

        <meta name="description" content="游览巴黎市区+枫丹白露宫和巴比桑小镇">
        <meta name="keywords" content="游览巴黎市区,枫丹白露宫,巴比桑小镇">
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>游览巴黎市区+枫丹白露宫和巴比桑小镇</h2><!--END TITLE-->

                <div class="singletours">

                      <img src="parisfontaineb300h.jpg" alt="游览巴黎市区+枫丹白露宫和巴比桑小镇" /> 
                      <p>出发时间：每周一，四，六下午1:30分从您入住的酒店出发<br />全程时长：大约8小时</p>
                      <p class="tourprice">费用 148 欧元</p>
        ...
        <div class="footer-container">
            <footer class="wrapper">
                ...
                <a href="fontainebleautours.php" title="游览枫丹白露宫和巴比桑小镇" class="tours">返回</a>
            </div>
            </footer>
