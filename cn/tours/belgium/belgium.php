...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 游览比利时</title>

        <meta name="description" content="游览比利时">
        <meta name="keywords" content="游览比利时">
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <h2>游览比利时</h2>
                    ...
                    <div class="tourscat">
                    <a href="brussels.php" title="布鲁塞尔"><img src="brussels160.jpg" alt="布鲁塞尔" /></a>
                    <p><a href="brussels.php" title="布鲁塞尔">布鲁塞尔</a></p>
                  </div>
