...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 布鲁塞尔观光游</title>

        <meta name="description" content="游览比利时: 布鲁塞尔观光游">
        <meta name="keywords" content="布鲁塞尔观光游,游览比利时">
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
              ...
              <p>出发时间：每周六早上7点 从您入住的酒店出发<br />全程时长：大约14个小时</p>
              <p class="tourprice">205.2 欧元</p>
