...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 巴黎市区和蒙特尔高地</title>

        <meta name="description" content="巴黎市区观光 - 巴黎市区和蒙特尔高地">
        <meta name="keywords" content="巴黎市区和蒙特尔高地,巴黎市区观光">
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
               ...
               <!--TITLE--><h2>巴黎市区和蒙特尔高地</h2><!--END TITLE-->

                    <div class="singletours">

                          <img src="montmartre300h.jpg" alt="巴黎市区和蒙特尔高地" /> 
                          <p>每天早上8:30或者13:30从您入住的酒店出发  全程时长：大概三个半小时</p>
