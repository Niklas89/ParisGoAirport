...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 巴黎市区观光</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>巴黎市区观光</h2><!--END TITLE-->

                  <div class="tourscat">
                    <a href="parisfullday.php" title="巴黎一日游"><img src="parisfullday160.jpg" alt="巴黎一日游" /></a>
                    <p><a href="parisfullday.php" title="巴黎一日游">巴黎一日游</a></p>
                  </div>


                  <div class="tourscat">
                    <a href="montmartre.php" title="巴黎市区&蒙特尔高地"><img src="montmartre160.jpg" alt="巴黎市区&蒙特尔高地" /></a>
                    <p><a href="montmartre.php" title="巴黎市区&蒙特尔高地">巴黎市区&蒙特尔高地</a></p>
                  </div>
                 

                  <div class="tourscat">
                    <a href="toureiffellunch.php" title="埃菲尔铁塔午餐"><img src="toureiffellunch160.jpg" alt="埃菲尔铁塔午餐" /></a>
                    <p><a href="toureiffellunch.php" title="埃菲尔铁塔午餐">巴黎市区观光&埃菲尔铁塔午餐</a></p>
                  </div>
