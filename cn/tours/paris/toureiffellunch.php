...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 巴黎市区观光以及在埃菲尔铁塔享用午餐</title>

        <meta name="description" content="巴黎市区观光 - 巴黎市区观光以及在埃菲尔铁塔享用午餐">
        <meta name="keywords" content="巴黎市区观光,埃菲尔铁塔午餐,巴黎市区观光以及在埃菲尔铁塔享用午餐">
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
               ...
               <!--TITLE--><h2>巴黎市区观光以及在埃菲尔铁塔享用午餐</h2><!--END TITLE-->

                    <div class="singletours">

                          <img src="toureiffellunch300h.jpg" alt="埃菲尔铁塔享用午餐" /> 
                          <p>每天早上8:30或者11:15 从您入住的酒店出发  全程时长：五个半小时</p>
                          <p class="tourprice">费用 72 欧元</p>
        ...
        <div class="footer-container">
            <footer class="wrapper">
                ...
                <a href="paristours.php" title="巴黎市区观光" class="tours">返回</a>
            </div>
            </footer>
