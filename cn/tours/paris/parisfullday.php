...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 巴黎市区一日游</title>

        <meta name="description" content="巴黎市区观光 - 巴黎市区一日游">
        <meta name="keywords" content="巴黎市区观光,巴黎市区一日游">
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
               ...
               <!--TITLE--><h2>巴黎市区一日游</h2><!--END TITLE-->

                    <div class="singletours">

                          <img src="parisfullday300h.jpg" alt="巴黎市区一日游" /> 
                          <p>每天早上8:30从你入住的酒店出发，全程大约：8小时</p>
                          <p class="tourprice">费用 175 欧元</p>
