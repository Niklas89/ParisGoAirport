        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
              <div class="paddingdiv">
               ...
               <form class="login-form" id="SignupForm" action="confirmreserv-disney.php" method="post">
                      ...
                      <p class="fieldsetpage">第1/4步</p>
                                 ...
                                 <div class="wrappper">
                                          <div class="styled-select">
                                              ...
                                              <select name="tfairport">
                                                <option value="迪斯尼乐园送机或接机">迪斯尼乐园送机或接机</option>
                                    ...
                                    <div class="wrappper">
                                          <div class="styled-select">
                                              ...
                                              <select name="location">
                                                <option value="您的位置" >您的位置</option>
                                                <option value="戴高乐机场(CDG)">戴高乐机场(CDG)</option>
                                                <option value="博韦机场(BVA)">博韦机场(BVA)</option>
                                                <option value="奥利机场(ORY)">奥利机场(ORY)</option>
                                                <option value="巴黎地址">巴黎地址</option>
                                              </select>
                                        </div>
                                      </div> 
                        ...
                        <input type="text" name="returningdate" class="input date" id="datepicker.[2]" value="返回日期" onFocus="this.value='';" onBlur="if(this.value==''){this.value='返回日期';}" />
                        <script type="text/javascript">
                           $(function() {
                        ...
                        <input type="text" class="input time" name="returningtime" id="timepicker.[2]" value="返回时间" onFocus="this.value='';" onBlur="if(this.value==''){this.value='返回时间';}" />
                        <script type="text/javascript">
                            $(document).ready(function() {
                         ...
                         <fieldset>
                          ...
                          <input name="flightnumb" type="text" id="flight" class="input flight" value="航班号（任意选择）" onFocus="this.value='';" onBlur="if(this.value==''){this.value='航班号（任意选择）';}" />
                                <input name="terminal" type="text" id="terminal" class="input terminal" value="航站楼（任意选择）" onFocus="this.value='';" onBlur="if(this.value==''){this.value='航站楼（任意选择）';}" /> 
                     <input name="way" type="hidden" value="<?php echo $way; ?>" />
                     <input name="airport" type="hidden" value="Disneyland" />
                        ...
                        <fieldset>
                          ...
                          <input name="parisaddress" type="text" class="input address" value="巴黎地址（任意选择）" onFocus="this.value='';" onBlur="if(this.value==''){this.value='巴黎地址（任意选择）';}" /> <br />
