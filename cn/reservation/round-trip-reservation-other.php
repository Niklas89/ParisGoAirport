               ...
               <form class="login-form" id="SignupForm" action="confirmreserv-other.php" method="post">
                      ...
                      <p class="fieldsetpage">第1/3步</p>
                        ...
                        <fieldset>
                          ...
                          <input type="text" name="arrivaldate" class="input date" id="datepicker.[1]" value="离港日期" onFocus="this.value='';" onBlur="if(this.value==''){this.value='离港日期';}" />
                        <script type="text/javascript">
                           $(function() {
                     ...
                     <input name="way" type="hidden" value="往返" />
