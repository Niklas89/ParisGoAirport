        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
              <div class="paddingdiv">
                ...
                <h2>戴高乐机场(CDG)-奥利机场(ORY) 往返接送服务</h2>
                                    ...
                                    <div class="wrappper">
                                          <div class="styled-select">
                                              ...
                                              <select name="tfairport">
                                                <option value="从奥利机场前往戴高乐机场" >从奥利机场前往戴高乐机场</option>
                                                <option value="从戴高乐机场前往奥利机场">从戴高乐机场前往奥利机场</option>
                                              </select>
                                        </div>
                                    </div> 
                         ...
                         <fieldset>
                          ...
                          <input name="flightnumb" type="text" id="flight" class="input flight" value="航班号" onFocus="this.value='';" onBlur="if(this.value==''){this.value='航班号';}" />
                                <input name="terminal" type="text" id="terminal" class="input terminal" value="航站楼" onFocus="this.value='';" onBlur="if(this.value==''){this.value='航站楼';}" /> 
                                 ...
                                 <input name="reflightnumb" type="text" id="flight" class="input flight" value="返回航班号" onFocus="this.value='';" onBlur="if(this.value==''){this.value='返回航班号';}" />
                                <input name="reterminal" type="text" id="terminal" class="input terminal" value="返回航站楼" onFocus="this.value='';" onBlur="if(this.value==''){this.value='返回航站楼';}" /> 
