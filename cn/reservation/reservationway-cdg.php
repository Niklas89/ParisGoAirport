...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 戴高乐机场 机场接机预订</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <h2>戴高乐机场(CDG) 接机预订</h2>
                 <a href="one-way-reservation.php?varget=<?php echo urlencode('戴高乐机场(CDG)'); ?>&amp;way=<?php echo urlencode('单程'); ?>" title="单程"><img src="../img/one-way.png" alt="单程" class="buttons-airport" width="160" /></a>
         <a href="round-trip-reservation.php?varget=<?php echo urlencode('戴高乐机场(CDG)'); ?>&amp;way=<?php echo urlencode('往返'); ?>" title="往返"><img src="../img/round-trip.png" alt="往返" class="buttons-airport" width="160" /></a><br />
