...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ParisGoAirport - 拼车接机</title>

        <meta name="description" content="巴黎接机 - 拼车接机">
        <meta name="keywords" content="巴黎接机,拼车接机">
            ...
            <div class="main wrapper clearfix">
                ...
                <div class="slider-wrapper theme-light">
                    <div id="slider" class="nivoSlider">
                        ...
                        <img src="img/services/viano_shared.jpg" alt="拼车接机" />
                        <img src="img/services/vito_interior.jpg" alt="梅赛德斯奔驰VITO" />
                    </div>
                </div>
                ...
                <ul class="shuttlepagedetails">
                    ...
                    <li>• <strong>拼车接机</strong>（最多8人）： 梅赛德斯奔驰VITO</li>
                </ul> 
