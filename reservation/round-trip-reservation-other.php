...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  $(function() {
    var data = [
      { label: "Eiffel Tower", category: "Paris city" },
      { label: "Montmartre", category: "Paris city" },
      { label: "Notre-Dame", category: "Paris city" },
      { label: "Louvre", category: "Paris city" },
      { label: "Beaubourg", category: "Paris city" },
      { label: "Grand Palais", category: "Paris city" },
      { label: "Arc de Triomphe", category: "Paris city" },
      { label: "Versailles", category: "Outside Paris" },
      { label: "Parc des Expositions", category: "Outside Paris" },
      { label: "Giverny", category: "Outside Paris" },
      { label: "Fontainebleau", category: "Outside Paris" },
      { label: "Barbizon", category: "Outside Paris" },
      { label: "Gare de l'Est", category: "Train Stations" },
      { label: "Gare d'Austerlitz", category: "Train Stations" },
      { label: "Gare de Bercy", category: "Train Stations" },
      { label: "Gare de Lyon", category: "Train Stations" },
      { label: "Gare Montparnasse", category: "Train Stations" },
      { label: "Gare du Nord", category: "Train Stations" },
      { label: "Gare Saint-Lazare", category: "Train Stations" }
    ];
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
              <div class="paddingdiv">
                ...
                <h2>Other destinations Round-Trip shuttle</h2>
               ...
               <form class="login-form" id="SignupForm" action="confirmreserv-other.php" method="post">
                            ...
                            <fieldset>
                      <p class="fieldsetpage">Step 1/3</p>
                                    ...
                                    <div class="wrappper">
                                     ...
                                     <input name="location" type="text" id="location" class="input location" value="<?php if (isset($_GET['location'])) { echo $location; } else { echo 'Destination';} ?>" />
                        ...
                        <fieldset>
                          ...
                          <p class="fieldsetpage">Step 2/3</p>
                          <input type="text" name="arrivaldate" class="input date" id="datepicker.[1]" value="Departing Date" onFocus="this.value='';" onBlur="if(this.value==''){this.value='Departing Date';}" />
                        <script type="text/javascript">
                           $(function() {
                        ...
                        <input type="text" class="input time" name="arrivaltime" id="timepicker.[1]" value="Departing Time" onFocus="this.value='';" onBlur="if(this.value==''){this.value='Departing Time';}" />
                        <script type="text/javascript">
                            $(document).ready(function() {
                        ...
                        <script type="text/javascript">
                         ...
                         <fieldset>
                          <p class="fieldsetpage">Step 3/3</p>
                     ...
                     <input name="way" type="hidden" value="Round-Trip" />
