        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
              <div class="paddingdiv">
                ...
                <h2>Other destinations One-Way shuttle transfers</h2>
                      ...
                      <fieldset>
                            <p class="fieldsetpage">Step 1/3</p>
                                    ...
                                    <fieldset>
                                      ...
                                      <input type="text" name="arrivaldate" class="input date" id="datepicker" value="Date" onFocus="this.value='';" onBlur="if(this.value==''){this.value='Date';}" />
                                    <script type="text/javascript">
                                       $(function() {
                                    ...
                                    <input type="text" class="input time" name="arrivaltime" id="timepicker.[1]" value="Time" onFocus="this.value='';" onBlur="if(this.value==''){this.value='Time';}" />
                                    <script type="text/javascript">
                                        $(document).ready(function() {
                                 ...
                                 <input name="way" type="hidden" value="One-Way" />
