    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <h2>CDG - Orly Transfer</h2>
                 <a href="one-way-reservation-airp.php?way=<?php echo urlencode('One-Way'); ?>" title="One-Way"><img src="../img/one-way.png" alt="One-Way" class="buttons-airport" width="160" /></a>
         <a href="round-trip-reservation-airp.php?way=<?php echo urlencode('Round-Trip'); ?>" title="Round-Trip"><img src="../img/round-trip.png" alt="Round-Trip" class="buttons-airport" width="160" /></a><br />
