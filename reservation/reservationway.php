    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <h2><?php echo $varget; ?> Airport Transfer</h2>
                ...
                <div class="choose-airport">
                 ...
                 <a href="one-way-reservation.php?varget=<?php echo urlencode($varget); ?>&amp;way=<?php echo urlencode('One-Way'); ?>" title="One-Way"><img src="../img/one-way.png" alt="One-Way" class="buttons-airport" width="160" /></a>
         <a href="round-trip-reservation.php?varget=<?php echo urlencode($varget); ?>&amp;way=<?php echo urlencode('Round-Trip'); ?>" title="Round-Trip"><img src="../img/round-trip.png" alt="Round-Trip" class="buttons-airport" width="160" /></a><br />
