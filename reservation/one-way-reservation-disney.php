        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
              <div class="paddingdiv">
                ...
                <h2>Disneyland <?php echo $way; ?> shuttle</h2>
               ...
               <form class="login-form" id="SignupForm" action="confirmreserv-disney.php" method="post">
                      ...
                      <fieldset>
                            <p class="fieldsetpage">Step 1/4</p>
                                    ...
                                    <div class="wrappper">
                                          <div class="styled-select">
                                              ...
                                              <select name="tfairport">
                                                <option value="To or From airport ?" >To or From Disneyland ?</option>
                                    ...
                                    <div class="wrappper">
                                          <div class="styled-select">
                                              ...
                                              <select name="location">
                                                ...
                                                <option value="Paris address">Paris address</option>
                                              </select>
                                        </div>
                                      </div> 
                                    ...
                                    <input name="flightnumb" type="text" id="flight" class="input flight" value="Flight Number (optional)" onFocus="this.value='';" onBlur="if(this.value==''){this.value='Flight Number (optional)';}" />
                                <input name="terminal" type="text" id="terminal" class="input terminal" value="Airport Terminal (optional)" onFocus="this.value='';" onBlur="if(this.value==''){this.value='Airport Terminal (optional)';}" /> 
                                 ...
                                 <input name="airport" type="hidden" value="Disneyland" />
                                    ...
                                    <fieldset>
                                      ...
                                      <input name="parisaddress" type="text" class="input address" value="Paris Address (optional)" onFocus="this.value='';" onBlur="if(this.value==''){this.value='Paris Address (optional)';}" /> <br />
