    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <h2>Transfers to other destinations</h2>
                 <a href="one-way-reservation-other.php?location=<?php echo urlencode($location); ?>" title="One-Way"><img src="../img/one-way.png" alt="One-Way" class="buttons-airport" width="160" /></a>
         <a href="round-trip-reservation-other.php?location=<?php echo urlencode($location); ?>" title="Round-Trip"><img src="../img/round-trip.png" alt="Round-Trip" class="buttons-airport" width="160" /></a><br />
