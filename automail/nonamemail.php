         <?php    if(isset($_POST['submit']))  {    
          ...
          require_once('../PHPMailer_5.2.4/class.phpmailer.php');
            ...
            try {
              $mailmessage = file_get_contents('nonamemail-template.html');
              ...
              $mail->Username   = "qsdqsd"; // SMTP account username
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
              <div class="paddingdiv">
                ...
                <h2>no recipient name auto mail</h2>
            ...
            elseif(isset($erreurid)){ ?>
              ...
              <form class="login-form" id="SignupForm" action="nonamemail.php" method="post">
