         <?php        if(isset($_POST['submit']))  { 
          ...
          require_once('../PHPMailer_5.2.4/class.phpmailer.php');
            ...
            try {
              $mailmessage = file_get_contents('namemail-template.html');
              ...
              $mail->Password   = "qsdqsd";        // SMTP account password
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
              <div class="paddingdiv">
                ...
                <h2>with recipient name auto mail</h2>
            ...
            elseif(isset($erreurid)){ ?>
              ...
              <form class="login-form" id="SignupForm" action="namemail.php" method="post">

                <p><a href="index.php" title="back">Back</a></p>

                 <input name="email" type="text" class="input email" value="Email" onFocus="this.value='';" onBlur="if(this.value==''){this.value='Email';}" /><br />
                                 
                 <input name="firstname" type="text" class="input firstname" value="Madam" onFocus="this.value='';" onBlur="if(this.value==''){this.value='Madam';}" />
                 <label>( Dear Sir, / Dear Madam, / Dear John, )</label>
