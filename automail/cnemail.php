         <?php    if(isset($_POST['submit']))  {    
          ...
          require_once('../PHPMailer_5.2.4/class.phpmailer.php');
            ...
            try {
              $mailmessage = file_get_contents('cnemail-template.html');
              ...
              $mail->Password   = "qdsqd";        // SMTP account password
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
              <div class="paddingdiv">
                ...
                <h2>小考拉要发邮件</h2>
                <p class="main-description">慢慢发吧</p>

                <?php if(isset($ok)){ echo '<h3 id="ok">'.$ok.'</h3>';} 
            elseif(isset($erreurid)){ ?>
            
              <?php echo '<h3 id="erreurid">'.$erreurid.'</h3>'; } ?>
              <form class="login-form" id="SignupForm" action="cnemail.php" method="post">
