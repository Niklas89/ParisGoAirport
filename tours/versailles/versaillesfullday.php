...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Versailles Sightseeing - Full-Day Tour</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>Versailles Sightseeing - Full-Day Tour</h2><!--END TITLE-->

        <div class="singletours">

              <img src="versailles300h.jpg" alt="Versailles Full-Day Tour" /> 
               <p>One whole day to discover the Castle of Versailles, the jewel of French architecture built under the reign of the Sun king, Louis XIV. Guided tour.</p>
              <p class="time">Departure: 8:30 am on Wednesdays, Saturdays and Sundays.  Duration: around 8hrs.</p>
              <p class="tourprice">185 €<br />Child 4-11 years old: 142 €</p>
