...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Versailles & the Louvre Sightseeing Tour</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>Versailles & the Louvre Tour</h2><!--END TITLE-->

        <div class="singletours">

              <img src="versailleslouvre300h.jpg" alt="Versailles & the Louvre" /> 
              <p>One whole day to discover first the Castle of Versailles, the jewel of French architecture built under the reign of the Sun king, Louis XIV.<br />
                Secondly, our guide will take you to the Louvre Museum in central Paris.</p>
              <p class="time">Departure from your hotel: 8.30 am everyday except Monday and Sunday. Duration: around 7hrs</p>
              <p class="tourprice">152 €<br />Child 4-11 years old: 78 €</p>
        ...
        <div class="footer-container">
            <footer class="wrapper">
                ...
                <a href="versaillestours.php" title="Versailles Tours" class="tours">Back</a>
            </div>
            </footer>
