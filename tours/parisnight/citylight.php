...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Paris Sightseeing Tours- The City of Light</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
               ...
               <!--TITLE--><h2>The City of Light</h2><!--END TITLE-->

                    <div class="singletours">

                          <img src="citylight300h.jpg" alt="The City of Light" /> 
                          ...
                          <p>You will appreciate this guided tour of Paris by night, where you will admire the most beautiful enlightened monuments of Paris. <br />
                            ...
                            <p class="time">Departure from your hotel : 9.15 pm every evening. Duration : around 2 hours.</p>
                          <p class="tourprice">60 €<br />Child 4-11 years old: 37 €</p>
                    </div>
