...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Tours in Paris by Night</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>Tours in Paris by Night</h2><!--END TITLE-->

                          <div class="tourscat">
                            <a href="nightcruise.php" title="Night Cruise"><img src="nightcruise160.jpg" alt="Night Cruise" /></a>
                            <p><a href="nightcruise.php" title="Night Cruise">The City of Light + Cruise on the Seine</a></p>
                          </div>

                         
                          <div class="tourscat">
                            <a href="citylight.php" title="The City of Light"><img src="citylight160.jpg" alt="The City of Light" /></a>
                            <p><a href="citylight.php" title="The City of Light">The City of Light</a></p>
                          </div>


                          <div class="tourscat">
                            <a href="dinnercruise.php" title="Dinner Cruise"><img src="dinnercruise160.jpg" alt="Dinner Cruise" /></a>
                            <p><a href="dinnercruise.php" title="Dinner Cruise">Dinner Cruise on the Seine</a></p>
                          </div>
