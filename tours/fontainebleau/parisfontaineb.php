...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Paris city tour + Fontainebleau & Barbizon</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>Paris city tour + Fontainebleau & Barbizon</h2><!--END TITLE-->

                <div class="singletours">

                      <img src="parisfontaineb300h.jpg" alt="Fontainebleau & Barbizon Tour" /> 
                      <p>Combination of Paris City Tour and Fontainebleau: you will discover Paris, its most famous monuments after the Palace of Fontainebleau and Barbizon village. 
                        The tickets and audio-guides for Fontainebleau are included in the price.</p>
                      <p class"time">Departure from your hotel : 8.30 am everyday except Tuesday Duration : around 9 hours</p>
                    <p class="tourprice">161 €<br />Child 4-11 years old: 90 €</p>
        ...
        <div class="footer-container">
            <footer class="wrapper">
                ...
                <a href="fontainebleautours.php" title="Fontainebleau Tours" class="tours">Back</a>
            </div>
            </footer>
