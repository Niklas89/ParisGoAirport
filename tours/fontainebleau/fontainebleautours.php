...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Fontainebleau & Barbizon Sightseeing Tours</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>Tours in Fontainebleau & Barbizon</h2><!--END TITLE-->

                 <div class="tourscat">
                    <a href="fontainebleau.php" title="Fontainebleau and Barbizon"><img src="fontainebleau160.jpg" alt="Fontainebleau and Barbizon" /></a>
                    <p><a href="fontainebleau.php" title="Fontainebleau and Barbizon">Fontainebleau & Barbizon</a></p>
                  </div>

                  <div class="tourscat">
                    <a href="parisfontaineb.php" title="Paris + Fontainebleau and Barbizon"><img src="parisfontaineb160.jpg" alt="Paris + Fontainebleau and Barbizon" /></a>
                    <p><a href="parisfontaineb.php" title="Paris + Fontainebleau and Barbizon">Paris city + Fontainebleau & Barbizon</a></p>
                  </div>
