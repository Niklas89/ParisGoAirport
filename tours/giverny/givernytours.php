...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Giverny Sightseeing Tours</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>Tours in Giverny</h2><!--END TITLE-->

                 <div class="tourscat">
                    <a href="giverny.php" title="Giverny"><img src="giverny160.jpg" alt="Giverny" /></a>
                    <p><a href="giverny.php" title="Giverny">Giverny</a></p>
                  </div>
