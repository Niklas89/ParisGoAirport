...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Disneyland Paris IN A DAY</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>Disneyland Paris IN A DAY</h2><!--END TITLE-->

                  <div class="singletours">

              <img src="disneyland300h.jpg" alt="Disneyland Paris" /> 
              <p>Experience either Disneyland Park AND/OR Walt Disney Studio Park in one day with our special voucher.<br /> Prices below: Adults/Children (3-11 years old)</p>
              <p class="time">Departure from your hotel: 8:30am every day.</p>
              <p class="tourprice">1 day / 1 park : 62 € - You save a minimum: 7 €<br />1 day / 2 parks : 71 € - You save a minimum: 8 €</p>
