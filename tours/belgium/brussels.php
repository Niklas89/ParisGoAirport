...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Sightseeing tours in Belgium</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <h2>Brussels - Sightseeing Tour</h2>

                  <div class="singletours">

              <img src="brussels300h.jpg" alt="Brussels" /> 
              <p>During this whole day you'll visit Brussels. You'll discover the monuments which are on the World Heritage List of Unesco: The Grand Place, 
                The mannequen Pis, old alleys, the City Hall, the Royal Palace... You'll walk around lots of shops and museums. <br />Free time for lunch and shopping</p>
              <p class"time">Departure from your hotel : 07.00 a.m every Tuesday and Saturday Duration : around 12 hours</p>
              <p class="tourprice">216 €<br />Child 4-11 years old: 167 €</p>
        ...
        <div class="footer-container">
            <footer class="wrapper">
                ...
                <a href="belgium.php" title="Belgium Tours" class="tours">Back</a>
            </div>
            </footer>
