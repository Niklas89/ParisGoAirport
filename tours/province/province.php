...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Province Sightseeing Tours</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
               ...
               <!--TITLE--><h2>Province Sightseeing Tours</h2><!--END TITLE-->

                      <div class="tourscat">
                        <a href="chateauxloire.php" title="Loire Valley Castles"><img src="chateauxloire160.jpg" alt="Loire Valley Castles" /></a>
                        <p><a href="chateauxloire.php" title="Loire Valley Castles">Loire Valley Castles</a></p>
                      </div>

                      <div class="tourscat">
                        <a href="saintmichel.php" title="Mont Saint-Michel"><img src="saintmichel160.jpg" alt="Mont Saint-Michel" /></a>
                        <p><a href="saintmichel.php" title="Mont Saint-Michel">Mont Saint-Michel</a></p>
                      </div>

                      <div class="tourscat">
                        <a href="dday.php" title="Normandie D-Day"><img src="dday160.jpg" alt="Normandie D-Day" /></a>
                        <p><a href="dday.php" title="Normandie D-Day">Normandie D-Day</a></p>
                      </div>
