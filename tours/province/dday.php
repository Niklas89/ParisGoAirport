...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Normandie D-Day Sightseeing Tour</title>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <!--TITLE--><h2>Normandie D-Day Tour</h2><!--END TITLE-->

        <div class="singletours">

              <img src="dday300h.jpg" alt="Normandie D-Day Tour" /> 
              <p>This time we will take you not so far back in history, to the Second World War. You'll follow the allies to the Omaha Beach, the Point of Hoc, Arromanche-les-Bains, their artificial harbour and finally the 
                American military cemetery of Saint Laurent.</p>
              <p class="time">Departure from your hotel : 7.00 a.m every Thursday and Sunday. Duration : around 12 hours.</p>
              <p class="tourprice">210 €<br />Child 4-11 years old: 177 €</p>
