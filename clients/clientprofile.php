            ...
            elseif(isset($erreurid)){ ?>
              ...
              <?php echo '<h3 id="erreurid">'.$erreurid.'</h3>'; } ?>
                ...
                <?php 
                      ...
                      $resultats=$bdd->query('SELECT * FROM personnes WHERE id=\'' . $_GET['id'] . '\' ORDER BY coldate DESC');
                                  ...
                                  <h3 class="title-prices-second"> 
                                    ...
                                    <?php if($resultat->tfairport == '送机') { ?>
                                     ...
                                     <?php echo $resultat->tfairport; ?>
                                       <?php } ?> <?php echo $resultat->airport; ?> <?php echo $resultat->terminal; ?></h3>
                                    <table>
                                        <tr>
                                           <th>Date of Reservation</th>
                                           <td><?php echo date('H:i:s \- jS \o\f F Y', strtotime($resultat->coldate)); ?></td>
                                       </tr>
                                       <tr>
                                           <th>Location</th>
                                       ...
                                       <?php if($resultat->shuservice == '私人包车') { ?>
                                       <tr>
                                           <th>Shuttle Service</th>
                                           <td>Private 私人包车</td>
                                       </tr>
                                       <?php } elseif($resultat->shuservice == '拼车') { ?>
                                       <tr>
                                           <th>Shuttle Service</th>
                                           <td>Shared 拼车</td>
                                       </tr>
                                     <?php } else { ?>
                                       <tr>
                                           <th>Shuttle Service</th>
                                           <td><?php echo $resultat->shuservice; ?></td>
                                       </tr>
                                       <?php } ?>
                                       ...
                                       <tr>
                                           ...
                                           <td><?php echo $resultat->nbchildren; ?></td>
                                       </tr>
